...
/**
 * A rectangle with a width, height, color, and position, describing the location of the
 * rectangle's upper-left corner. Uses the {@link ShapeType} {@code Rectangle}.
 */
public class Rectangle extends AShape {
  /**
   * Creates a rectangle given the location of its upper-left corner, its width and height, and
   * its color.
   *
